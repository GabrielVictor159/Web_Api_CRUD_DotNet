...
namespace gcsb.ecommerce.tests.Cases.Application.Order.UpdateOrder.Handlers
{
    ...
    public class CreateListOrderProductHandlerTest
    {
        ...
        public CreateListOrderProductHandlerTest(
        ...
        [Fact]
        public async Task ShouldNewAttributesOrderNotBeNullListOrderProductNotBeNullOrEmptyProcessRequest()
        {
            ...
            request.NewAttributesOrder.Should().NotBeNull();
            request.NewAttributesOrder!.ListOrderProduct.Should().NotBeNullOrEmpty();
        }
    }
}