...
{
    public class GetClientsPresenter : IOutputPort<List<GetClientOutput>>
    {
        ...
        public void Standard(List<GetClientOutput> output)
        {
            var response = new GetClientsResponse(output);
